So you've started using `faker-optional` and want to show your gratitude to the project,
...
* [Open an issue](https://github.com/lyz-code/faker-optional/issues/new) if you encounter
    any bug or to let us know if you want a new feature to be implemented.
* Spread the word about the program.
* Review the [documentation](https://lyz-code.github.io/faker-optional) and try to improve
    it.

# I know how to program in Python

If you have some python knowledge there are some additional ways to contribute.
We've ordered the [issues](https://github.com/lyz-code/faker-optional/issues) in
[milestones](https://github.com/lyz-code/faker-optional/milestones), check the issues in
the smaller one, as it's where we'll be spending most of our efforts. Try the
[good first
issues](https://github.com/lyz-code/faker-optional/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22),
...
[documentation](https://lyz-code.github.io/faker-optional) of the project, so think if
...
policy](https://github.com/lyz-code/faker-optional/security/policy) instead.**
...
Please try to always include the above unless you're unable to install `faker-optional` or know it's not relevant to your question or
feature request.

# Pull Requests

*faker-optional* is released regularly so you should see your
...
wanted"](https://github.com/lyz-code/faker-optional/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
label on github.
...
* Clone your fork and go into the repository directory:
    ...
    ```bash
    git clone git@github.com:<your username>/faker-optional.git
    cd faker-optional
    ```
...
* Install faker-optional, dependencies and configure the
    pre-commits:
...
* Fix formatting and imports: faker-optional uses
...
We'd love you to contribute to *faker-optional*!
